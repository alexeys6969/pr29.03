package com.example.myapplication.datas.workers;
...
import com.example.myapplication.datas.apis.WeatherApi;
import com.example.myapplication.datas.apis.WeatherResponse;
import com.example.myapplication.datas.callbacks.MyResponseCallback;
import com.example.myapplication.datas.databases.WeatherContext;
import com.example.myapplication.domains.models.Day;
import com.example.myapplication.presentations.utils.DataNotifier;
...
public class WeatherWorker extends Worker {
    ...
    public Result doWork() {
        ...
        try {
            WeatherApi weatherApi = new WeatherApi(58, 56, WeatherResponse);
            weatherApi.execute();
    ...
    MyResponseCallback WeatherResponse = new MyResponseCallback() {
        @Override
        public void onCompile(String result) {
            ...
            for(com.example.myapplication.datas.apis.WeatherResponse.Forecast forecast : weatherResponse.forecasts) {
    ...
    public Integer avgTemp(List<WeatherResponse.Forecast.Hour> hours) {
        Float sumTemp = 0f;
        for(com.example.myapplication.datas.apis.WeatherResponse.Forecast.Hour hour : hours)
            sumTemp += hour.temp;
